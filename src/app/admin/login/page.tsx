  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-6 py-12">
      <div className="w-full max-w-4xl">
        ...
        <div className="grid overflow-hidden rounded-[var(--radius-lg)] border border-border bg-bg-alt shadow-[0_20px_60px_-15px_rgba(11,18,48,0.12)] md:grid-cols-2">
          ...
          <div className="relative hidden flex-col items-center justify-center overflow-hidden bg-bg px-10 py-16 md:flex">
            ...
            <div className="relative mt-6 select-none font-display text-2xl font-extrabold leading-none tracking-tight">
              <span className="text-accent">INFO</span>
              <span className="text-fg">SIS</span>
              <span className="text-accent">TEL</span>
            </div>
            <p className="relative mt-2 text-xs font-bold uppercase tracking-[0.3em] text-fg-muted">
